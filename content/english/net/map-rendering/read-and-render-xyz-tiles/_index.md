---
title: Read and Render XYZ Tiles
linktitle: Read and Render XYZ Tiles
second_title: Aspose.GIS .NET API
description: 
type: docs
weight: 12
url: /net/map-rendering/read-and-render-xyz-tiles/
---
...
namespace Aspose.GIS_for.NET.Rendering
{
    public static class ReadTilesFromXyzFormat
    {
        ...
        private static void OpenStreetXyzTile()
        {
            ...
            var mapPath = Path.Combine("Your Document Directory", "out_osm_tile.png");
        ...
        private static void OpenStreetXyzTiles()
        {
            ...
            var mapPath = Path.Combine("Your Document Directory", "out_osm_tiles.png");
