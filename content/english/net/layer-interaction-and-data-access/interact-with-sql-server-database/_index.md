---
title: Interact with SQL Server Database
linktitle: Interact with SQL Server Database
second_title: Aspose.GIS .NET API
description: 
type: docs
weight: 19
url: /net/layer-interaction-and-data-access/interact-with-sql-server-database/
---
...
namespace Aspose.GIS.Examples.CSharp.Layers
{
    public static class InteractWithSqlServerDatabase
    {
        ...
        public static void ExportSqlServerTable(string connectionString)
        {
            ...
            var outputPath = Path.Combine("Your Document Directory", "sql_server_out.kml");
