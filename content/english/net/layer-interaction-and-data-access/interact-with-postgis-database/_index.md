---
title: Interact with PostGIS Database
linktitle: Interact with PostGIS Database
second_title: Aspose.GIS .NET API
description: 
type: docs
weight: 18
url: /net/layer-interaction-and-data-access/interact-with-postgis-database/
---
...
namespace Aspose.GIS.Examples.CSharp.Layers
{
    public static class InteractWithPostGisDatabase
    {
        ...
        public static void ExportPostGisTable(string postgreSqlConnectionString)
        {
            ...
            var outputPath = Path.Combine("Your Document Directory", "postgres_out.shp");
