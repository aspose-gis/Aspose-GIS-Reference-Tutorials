...
namespace Aspose.GIS_for.NET.Layers
{
    class ModifyFeatures
    {
        ...
        {
            dataDir = "Your Document Directory";
        ...
        private static void AddFeaturesInExistShapeFile()
        {
            ...
            var fromPath = Path.Combine("Your Document Directory", "point_xyz");
            var toPath = "Your Document Directory" + "point_xyz_out";
        ...
        private static void ModifyFeaturesInDataset()
        {
            ...
            var path = Path.Combine("Your Document Directory", "ThreeLayers.gdb");
            var datasetPath = "Your Document Directory" + "ModifyFeaturesInDataset_out.gdb";
