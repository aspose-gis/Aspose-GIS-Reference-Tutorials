...
В этом пошаговом руководстве вы узнаете **как конвертировать файлы GeoJSON** в TopoJSON с группировкой объектов на основе атрибута атрибута.Использование Aspose.GIS.NET API для быстрой, надежной и полностью управляемой конвертации из вашего кода C#. Независимо от того, создадите ли вы сервис конвертации GeoJSON в ASP.NET или настольный ГИС-инструмент, это руководство покажет, что именно нужно сделать, чтобы **конвертировать geojson в topojson** эффективно.
...
Во-первых, добавьте необходимые пространства имен в ваш проект:
...
Выполните преобразование с помощью одного вызова API:
