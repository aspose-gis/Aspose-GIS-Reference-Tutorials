...
## FAQ
### Aspose.GIS for .NET을 .NET Core 또는 .NET Standard와 같은 다른 .NET 프레임워크와 함께 사용할 수 있습니까?
예, Aspose.GIS for .NET은 .NET Core 및 .NET Standard를 포함하며 다양한 .NET 프레임워크와 호환됩니다.
### Aspose.GIS for .NET의 체험판 버전을 제공하시겠습니까?
예, [출시 페이지](https://releases.aspose.com/)에서 무료 체험판을 받으실 수 있습니다.
### Aspose.GIS for .NET에 대한 전반적인 문서는 찾을 수 없나요?
자세한 정보와 예제는 [문서](https://reference.aspose.com/gis/net/)를 참고하시기 바랍니다.
### Aspose.GIS for .NET의 기동력은 어떻게 얻을 수 있나요?
임시 선반은 Aspose.GIS용 [구매 페이지](https://purchase.aspose.com/temporary-license/)에서 구매할 수 있습니다.
### Aspose.GIS for .NET에 대한 지원이나 지원을 받을 수 있습니까?
질문, 토론, 지원이 필요하면 Aspose.GIS [포럼](https://forum.aspose.com/c/gis/33)을 방문하시기 바랍니다.

## 자주 묻는 질문
**Q: 제한 제한이 원본 Shapefile에 영향을 미치나요?**
답: 그렇지 않습니다. 기본은 지오메트리를 복사하여 적용하고, 원본 파일을 변경합니다.

**Q: X와 Y 등록소에 다른 정당한 모델을 사용할 수 있습니까?**
A: 현재 Aspose.GIS는 두 축에 같은 `XYPrecisionModel`을 적용합니다.

**Q: 사용자 정의 반올림에 접근할 수 있나요?**
A: API는 기본적으로 'PrecisionModel.Rounding(int)' 메서드를 제공합니다. 사용자 정의 기반이 필요하다면 후광을 삼각형으로 처리해야 합니다.
