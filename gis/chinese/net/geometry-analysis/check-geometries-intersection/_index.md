...
### 步骤 3：检查不相交的几何图形（与 Intersects 操作相反）
...
**问：** Aspose.GIS for .NET 可以与其他 .NET 框架一起使用吗？

**答：** 可以，Aspose.GIS for .NET 与多种 .NET 框架兼容，包括 .NET Core 和 .NET Framework。

**问：** Aspose.GIS for .NET 提供免费试用版吗？

**答：** 您可以从[此处](https://releases.aspose.com/)获取 Aspose.GIS for .NET 的免费试用版。

**问：** 我在哪里可以获得 Aspose.GIS for .NET 的支持？

**答：** 您可以在[Aspose.GIS 论坛](https://forum.aspose.com/c/gis/33)上寻求帮助并与社区互动。

**问：** 我可以获得 Aspose.GIS for .NET 的临时许可证吗？

**答：** 可以，您可以从[此处](https://purchase.aspose.com/temporary-license/)获取临时许可证。

**问：** 我可以在哪里购买 Aspose.GIS for .NET 的授权版本？
